...
(function(j) {
    ...
    q(C.prototype, {
        ...
        drawLegendSymbol: function(a, b) {
            var c = a.padding,
                d = a.options,
                e = this.horiz,
                f = n(d.symbolWidth, e ? 200 : 12),
                g = n(d.symbolHeight, e ? 12 : 200),
                h = n(d.labelPadding, e ? 16 : 30),
                d = n(d.itemDistance, 10);
            this.setLegendColor();
            b.legendSymbol = this.chart.renderer.rect(0,
                a.baseline - 11, f, g).attr({
                zIndex: 1
            }).add(b.legendGroup);
        ...
        drawCrosshair: function(a, b) {
            ...
            if (b) f = this.toPixels(b.value), f < g ? f = g - 2 : f > g + h && (f = g + h + 2), b.plotX = f, b.plotY = this.len - f, o.prototype.drawCrosshair.call(this,
                a, b), b.plotX = d, b.plotY = e, !c && this.cross && this.cross.attr({
    ...
    q(z.prototype, {
        renderMapNavigation: function() {
            ...
            if (n(b.enableButtons, b.enabled) && !a.renderer.forExport)
                for (d in c)
                    if (c.hasOwnProperty(d)) f = m(b.buttonOptions, c[d]), e = f.theme, g = e.states, e = a.renderer.button(f.text,
    ...
    v = u(A, {
        applyOptions: function(a, b) {
            var c = A.prototype.applyOptions.call(this, a, b),
                d = this.series,
                e = d.joinBy;
            if (d.mapData)
        ...
        setData: function(a, b) {
            ...
            if (d) {
                ...
                c.allAreas && (a = a || [], e[1] && i(a, function(a) {
                    ...
                    (!e[0] || g.indexOf("|" + b[e[0]] + "|") === -1) && a.push(m(b, {
                        value: null
                    }))
                }))
            }
    ...
    if (k.bubble) r.mapbubble =
        m(r.bubble, {
            ...
            pointClass: u(A, {
                applyOptions: v.prototype.applyOptions
            }),
            xyFromShape: !0,
            type: "mapbubble",
            pointArrayMap: ["z"],
    ...
    j.geojson = function(a, b, c) {
        ...
        i(a.features, function(a) {
            ...
            b === "map" || b === "mapbubble" ? (j === "Polygon" ? (i(c, f), e.push("Z")) : j === "MultiPolygon" && (i(c, function(a) {
                ...
                path: e
            })) : b === "mapline" ? (j === "LineString" ? f(c) : j === "MultiLineString" && i(c, f), e.length && (k = {
                path: e
            })) : b === "mappoint" && j === "Point" && (k = {
                x: c[0],
                y: -c[1]
            });
            k && d.push(q(k, {
