function translateToMap(jsonPlaces) {
	//console.log(typeof jsonPlaces);
	
	var jsonCountryOutput = [];
	var jsonData = grabJsonList();
...
function grabJsonPlaceToCountry(){	//"null" ignored
	return	{"Denmark":["Copenhagen"],
			"South Africa":["Pretoria"],
			"Israel":["Jerusalem"],
			"United Arab Emirates":["Abu Dhabi", "Asia/Dubai"],
			"Indonesia":["Jakarta"],
			"Malaysia":["Asia/Kuala_Lumpur", "Kuala Lumpur"],
			"Macedonia, FYR":["Skopje"],
			"Sri Lanka":["Sri Jayawardenepura"],
			"United States":["America/Los_Angeles", "Mountain Time (US & Canada)", "America/Resolute", "CST", "America/New_York", "Midway Island", "America/Denver","Hawaii", "Central Time (US & Canada)", "International Date Line West", "America/Chicago", "Indiana (East)", "America/Phoenix", "America/Boise", "Eastern Time (US & Canada)", "America/Detroit", "EST", "Pacific Time (US & Canada)", "PST", "MST", "Arizona", "Mid-Atlantic", "Alaska"],
			"Romania":["Bucharest"],
			"Australia":["Melbourne", "Darwin", "Hobart", "Brisbane", "Adelaide", "Canberra", "Sydney", "Perth"],
			"Turkey":["Istanbul"],
			"New Zealand":["Auckland", "Pacific/Auckland", "Wellington"],
			"Ukraine":["Kyiv"],
			"Poland":["Warsaw"],
			"Russian Federation":["St. Petersburg", "Moscow", "Volgograd", "Novosibirsk", "Europe/Moscow", "Kamchatka", "Ekaterinburg", "Irkutsk", "Vladivostok", "Magadan", "Krasnoyarsk", "Yakutsk"],
			"Germany":["Berlin","CET"],
			"Argentina":["Buenos Aires"],
			"France":["Paris", "UTC"],
			"Kuwait":["Kuwait"],
			"Mexico":["Guadalajara", "Monterrey", "Mazatlan", "Tijuana", "Mexico City", "Chihuahua"],
			...
			"Canada":["Atlantic Time (Canada)", "America/Vancouver", "America/Toronto", "America/Halifax", "America/Edmonton", "Newfoundland", "Saskatchewan"],
			"China":["Chongqing", "Beijing"],
			"Oman":["Muscat"],
			"Croatia":["Zagreb"],
			"Saudi Arabia":["Riyadh"],
			"Georgia":["Tbilisi"],
			"Italy":["Rome"],
			"Ecuador":["Quito"],
			"Pakistan":["Asia/Karachi", "Karachi", "Islamabad"],
			"Hungary":["Budapest"],
			"Sweden":["Stockholm"],
			"Belgium":["Brussels"],
			"India":["Mumbai", "Chennai", "New Delhi", "Kolkata"],
			"Latvia":["Riga"],
			"Liberia":["Monrovia"],
			"United Kingdom":["Edinburgh", "London", "GMT", "BST", "Europe/London"], //BST could move to bang burm or burk
