...
put(Bucket, Key, Value) ->
	...
	{tweet,{_,_,_,{_,Location},_}} = Value,
...
map_weight(RiakObject, _, _) ->
	{tweet,{_,_,{weight,W},{timezone,TZ},_}} = binary_to_term(riak_object:get_value(RiakObject)),
...
quickmr() ->
	{ok, Keys} = query_date_range("MaximumTestBucket","0","9"),
